...
static char *fonts[]          = { font, "JoyPixels:pixelsize=14:antialias=true:autohint=true"  };
...
const char *spcmd1[] = {TERMINAL, "-n", "spterm", "-g", "80x20", "-e", "notetaker", NULL };
const char *spcmd2[] = {TERMINAL, "-n", "spterm", "-g", "80x20", "-e", "~/project/scripts/notetaker", NULL };
...
static Key keys[] = {
    ...
    {MODKEY|ShiftMask,  XK_b,       spawn,      SHCMD("project/olam-parser/dict") },
	/* { MODKEY|ShiftMask,		XK_b,		spawn,		SHCMD("") }, */
    { MODKEY,          XK_w,        spawn,      SHCMD("	feh --randomize --bg-fill ~/Pictures/Wallpapers/animewal/*") },
	{ MODKEY,			XK_n,		spawn,		SHCMD("mostRecentNote") },
